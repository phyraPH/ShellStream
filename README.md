...
* another note: CFO version was recently been detected under DefenseEvasion.A!ml. I'll be rewriting this soon. But for now you can go through the commits and use the versions without the loop.
# ShellStream
